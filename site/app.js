...
async function loadE007() {
  ...
  if (!target) return;
  try {
    const [designResponse, worldResponse, smokeResponse, smokeResultsResponse, panelResponse, judge1Response, judge2Response, judge3Response, attentionResponse] = await Promise.all([
