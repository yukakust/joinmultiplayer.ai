...
async function loadE007TenButtons() {
  ...
  if (!target) return;
  try {
    const [protocolResponse, resultResponse, sanityProtocolResponse, sanityResultResponse, ladderProtocolResponse, ladderResultResponse, ninetyProtocolResponse, ninetyResultResponse, reversedProtocolResponse, reversedResultResponse, numericProtocolResponse, numericResultResponse, calibrationProtocolResponse, calibrationResultResponse, nonceProtocolResponse, nonceResultResponse] = await Promise.all([
