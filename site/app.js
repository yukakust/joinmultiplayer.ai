...
async function loadE007LocalLibrary() {
  ...
  if (!target) return;
  try {
    const [response, resultResponse, inventoryResponse, readerResponse] = await Promise.all([
