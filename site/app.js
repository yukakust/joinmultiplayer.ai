...
async function loadE005Gate5B() {
  ...
  try {
    ...
    target.querySelector(".e005-gate4-lessons-status strong").textContent = localized({ en: "TRACKS AND BRIDGE TRAINED · LOCKED EXAM NEVER RUN", ru: "ТРЕКИ И МОСТИК ОБУЧЕНЫ · ЭКЗАМЕН НЕ ЗАПУСКАЛСЯ" });
