...
EXPECTED_REVISION="d2ec419639db81ca4985a4bbacd2bb7d62561f36"
SHORT_REVISION="d2ec419"
...
BUILD_DIR="$(mktemp -d "$DOWNLOADS_DIR/pocket-i-checkpoint7n-build.XXXXXX")"
...
echo "Building Pocket i approved local harness from: $SHORT_REVISION"
...
if [ "$APP_VERSION" != "0.1.0-alpha.15" ]; then
