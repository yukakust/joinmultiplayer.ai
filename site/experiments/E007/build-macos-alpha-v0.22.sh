...
EXPECTED_REVISION="6ef608168ebc31ac782327c67bd3b1108d1b9820"
SHORT_REVISION="6ef6081"
...
BUILD_DIR="$(mktemp -d "$DOWNLOADS_DIR/pocket-i-checkpoint7s11-build.XXXXXX")"
...
echo "Building Pocket i with explicit relevance decisions from: $SHORT_REVISION"
...
if [ "$APP_VERSION" != "0.1.0-alpha.24" ]; then
