...
EXPECTED_REVISION="664a86dd5e71fe408e9d644420b9682eace64330"
SHORT_REVISION="664a86d"
...
echo "Preparing Vitaly's closed alpha build..."
umask 077
...
const manifest = require(process.env.REPO_DIR + "/desktop/app/model-manifest.json");
const access = require(process.env.REPO_DIR + "/desktop/app/remote-access.json");
