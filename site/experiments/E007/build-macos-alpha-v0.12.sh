...
EXPECTED_REVISION="9a4b6502e5328101fb7034b2e98a09b43741a915"
SHORT_REVISION="9a4b650"
...
BUILD_DIR="$(mktemp -d "$DOWNLOADS_DIR/pocket-i-checkpoint7m-build.XXXXXX")"
...
echo "Building Pocket i full harness from: $SHORT_REVISION"
...
if [ "$APP_VERSION" != "0.1.0-alpha.14" ]; then
