...
EXPECTED_REVISION="55a99bc5c6fc906fb8b4dd3e2c3477a56a2c104d"
SHORT_REVISION="55a99bc"
...
BUILD_DIR="$(mktemp -d "$DOWNLOADS_DIR/pocket-i-checkpoint7s6-build.XXXXXX")"
...
echo "Building Pocket i with the repaired bounded local envelope from: $SHORT_REVISION"
...
if [ "$APP_VERSION" != "0.1.0-alpha.22" ]; then
