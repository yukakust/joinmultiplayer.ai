...
EXPECTED_REVISION="a14731fac6bf20aca6c8c444e7e9d033bab8fb8f"
SHORT_REVISION="a14731f"
...
BUILD_DIR="$(mktemp -d "$DOWNLOADS_DIR/pocket-i-checkpoint7s9-build.XXXXXX")"
...
echo "Building Pocket i with partial relevance recovery from: $SHORT_REVISION"
...
if [ "$APP_VERSION" != "0.1.0-alpha.23" ]; then
