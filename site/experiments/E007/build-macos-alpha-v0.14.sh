...
EXPECTED_REVISION="8da5c7a9de1f7ca45febd8d9c31e6ae165aa1fc5"
SHORT_REVISION="8da5c7a"
...
echo "Building Pocket i with durable private test logs from: $SHORT_REVISION"
...
if [ "$APP_VERSION" != "0.1.0-alpha.16" ]; then
