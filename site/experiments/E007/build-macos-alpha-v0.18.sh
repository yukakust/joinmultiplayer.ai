...
EXPECTED_REVISION="00d80c31d66a5ee5aeba45b29be50eb536ad8261"
SHORT_REVISION="00d80c3"
...
BUILD_DIR="$(mktemp -d "$DOWNLOADS_DIR/pocket-i-checkpoint7r-build.XXXXXX")"
...
echo "Building Pocket i with durable private stage logs from: $SHORT_REVISION"
...
for packed_module in audit-store.cjs reranker.cjs remote-inference.cjs secret-scan.cjs; do
...
if [ "$APP_VERSION" != "0.1.0-alpha.20" ]; then
