...
EXPECTED_REVISION="c1fb60b2c12d4dbcc1aa6a73f8b9a4b61ae32fc8"
SHORT_REVISION="c1fb60b"
...
BUILD_DIR="$(mktemp -d "$DOWNLOADS_DIR/pocket-i-checkpoint7q-build.XXXXXX")"
...
echo "Building Pocket i with its brain on yukabox from: $SHORT_REVISION"
...
if [ "$APP_VERSION" != "0.1.0-alpha.19" ]; then
