#!/usr/bin/env python3
"""Build E007 Gate 3C.6L: mirrored KSEL/PTHY mappings."""
...
OUT = ROOT / "site/experiments/E007/nonce-word-world-v0.1.json"
DECKS = {
    "MAIN": {"KSEL": "approve", "PTHY": "reject"},
    "MIRROR": {"KSEL": "reject", "PTHY": "approve"},
}
MEANINGS = {
...
def prompt_for(case: dict, mapping: dict[str, str]) -> str:
    return (
        ...
        f"SOURCE:\n{case['source']}\n\n"
        f"PROPOSED ANSWER:\n{case['answer']}\n\n"
        "Choose exactly one: KSEL or PTHY.\n"
        f"KSEL = {MEANINGS[mapping['KSEL']]}.\n"
        f"PTHY = {MEANINGS[mapping['PTHY']]}.\n"
        "CHOICE:"
    )
