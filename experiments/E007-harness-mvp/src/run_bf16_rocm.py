#!/usr/bin/env python3
"""Run locked E007 Gate 16B.4 against a local llama-server BF16 endpoint."""
...
def main() -> None:
    ...
    parser.add_argument("--base-url", default="http://127.0.0.1:11437")
    ...
    for case in CASES:
        ...
        user_prompt = prompt(case, transcript)
