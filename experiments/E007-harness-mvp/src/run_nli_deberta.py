#!/usr/bin/env python3
"""Run the frozen E007 stronger-NLI comparison."""
...
PROTOCOL_PATH = ROOT / "site/experiments/E007/nli-deberta-protocol-v0.1.json"
WORLD_PATH = ROOT / "site/experiments/E007/nli-minilm-world-v0.1.json"
BASELINE_PATH = ROOT / "site/experiments/E007/nli-minilm-result-v0.1.json"
RESULT_PATH = ROOT / "site/experiments/E007/nli-deberta-result-v0.1.json"
...
def main() -> None:
    ...
    model.eval()
    records = []
    class_correct = {label: 0 for label in spec["classes"]}
    class_total = {label: 0 for label in spec["classes"]}
    ...
    for item in world["items"]:
        ...
        records.append({
            **item,
            ...
            "minilm_decision": old["decision"],
            "minilm_correct": old["correct"]
        })
    correct = sum(record["correct"] for record in records)
    gate = protocol["locked_development_gate"]
    passed = (
        correct > baseline["summary"]["correct"]
        and correct >= gate["total_correct_at_least"]
    ...
    result = {
        ...
        "experiment_id": "E007",
        "checkpoint": "3C.6O",
        "status": "comparative_development_complete",
        "protocol": "/experiments/E007/nli-deberta-protocol-v0.1.json",
        ...
        "summary": {
            "correct": correct,
            "total": len(records),
            "minilm_correct": baseline["summary"]["correct"],
