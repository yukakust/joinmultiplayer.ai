...
Результат: Gate провален. Qwen сохранила точную цитату для `6/9` обоснованных и `4/17` необоснованных кандидатов; ещё три ответа имели сломанный формат. Multilingual DeBERTa пропустила `2/6` обоснованных и `2/4` необоснованных кандидатов с точными цитатами. Финал: `2/9` полезных сохранено, `2/17` ошибок пропущено. Связку нельзя использовать как приёмочный фильтр MVP: она уменьшает шум, но уничтожает recall.
