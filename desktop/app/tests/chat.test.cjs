...
test("question relevance preserves explicit decisions and drops omitted claims without retry", { skip: process.platform === "win32" }, async () => {
...
`, { mode: 0o700 });
  ...
  assert.deepEqual(relevance.omitted_ids, ["E2", "E3", "E4"]);
});
